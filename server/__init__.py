...
def create_app():
    ...
    from .views import assignment_views, notice_views, onlinelecture_views, idwithsubject_views, subject, user_views
    ...
    app.register_blueprint(idwithsubject_views.bp)
